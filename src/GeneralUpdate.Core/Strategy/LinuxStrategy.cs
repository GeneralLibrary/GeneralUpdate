...
public class LinuxStrategy : AbstractStrategy
{
    ...
    protected override PipelineBuilder BuildPipeline(PipelineContext context)
    {
        ...
        GeneralTracer.Info($"GeneralUpdate.Core.LinuxStrategy.BuildPipeline: assembling middleware pipeline. PatchEnabled={_configinfo.PatchEnabled}, PackageType={packageType}, NeedsPatch={needsPatch}");
