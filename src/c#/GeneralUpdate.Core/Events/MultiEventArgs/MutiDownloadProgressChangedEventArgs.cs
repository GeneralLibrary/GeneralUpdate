...
namespace GeneralUpdate.Core.Events.MultiEventArgs
{
    public class MultiDownloadProgressChangedEventArgs : EventArgs
    {
        ...
        public MultiDownloadProgressChangedEventArgs(object version, long bytesReceived, long totalBytesToReceive, float progressPercentage, object userState, string message = null)
        {
            BytesReceived = bytesReceived;
            TotalBytesToReceive = totalBytesToReceive;
            ProgressPercentage = progressPercentage;
