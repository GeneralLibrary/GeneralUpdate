...
{
    /// <summary>
    /// Windows platform-specific update strategy.
    /// Implements the update flow for the Windows operating system, including pipeline building,
    /// hash verification, decompression, and patch application.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This class inherits from <c>AbstractStrategy</c> and provides complete update lifecycle management for the Windows environment.
    /// </para>
    /// <para>
    /// Core flow:
    /// <list type="number">
    ...
    /// </para>
    /// <para>
    /// The patching feature is controlled by the <c>PatchEnabled</c> configuration. When enabled, the pipeline
    /// includes <c>PatchMiddleware</c>; when disabled, this step is skipped.
    /// </para>
    /// </remarks>
    public class WindowsStrategy : AbstractStrategy
    {
        ...
        /// <summary>
        /// Builds the Windows platform update middleware pipeline.
        /// </summary>
