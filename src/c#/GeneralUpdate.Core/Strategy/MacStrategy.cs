...
public class MacStrategy : AbstractStrategy
{
    ...
    protected override PipelineBuilder BuildPipeline(PipelineContext context)
    {
        ...
        GeneralTracer.Info($"MacStrategy.BuildPipeline: assembling middleware pipeline. PatchEnabled={_configinfo.PatchEnabled}, PackageType={packageType}, NeedsPatch={needsPatch}");
