...
namespace GeneralUpdate.Core.Configuration
{
    ...
    /// <remarks>
    ///     <para>
    ///         <c>ProcessInfo</c> is the data transfer contract between the client process and the upgrade process
    ///         in the update workflow. Its lifecycle is as follows:
    ///         <list type="number">
    ///             <item>
    ///                 <description>
    ///                     Created at the end of the client update pipeline by
    ///                     <see cref="ConfigurationMapper.MapToProcessInfo" /> from
    ///                     <see cref="GlobalConfigInfo" />.
    ///                 </description>
    ///             </item>
    ///             <item>
    ///                 <description>
    ///                     Serialized to a JSON string and stored in the <see cref="GlobalConfigInfo.ProcessInfo" /> property.
    ///                 </description>
    ///             </item>
    ///             <item>
    ///                 <description>
    ...
    ///             <item>
    ///                 <description>
    ///                     The upgrade process deserializes the JSON string, reconstructs the <c>ProcessInfo</c> object,
    ...
    public class ProcessInfo
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Required when deserializing a <c>ProcessInfo</c> JSON string using
        ///     <see cref="System.Text.Json.JsonSerializer.Deserialize{T}(string, System.Text.Json.JsonSerializerOptions)" />.
        /// </remarks>
        public ProcessInfo() { }

        /// <summary>
        ///     Parameterized constructor with validation for creating a <c>ProcessInfo</c> instance.
        ...
        /// </remarks>
        /// <param name="appName">
        ///     The application name to launch after the update completes (mapped from <see cref="BaseConfigInfo.MainAppName" />).
        /// </param>
        ...
        ///     Note: In <c>ProcessInfo</c>, this field stores the <c>MainAppName</c> value from other configuration classes.
        /// </summary>
        /// <remarks>
        ...
        ///     Note: This value is mapped from <see cref="GlobalConfigInfo.ClientVersion" />.
        /// </summary>
        ...
        ///     Note: The property name here (<c>BlackFileFormats</c>) differs from other configuration classes
        ///     (<c>BlackFormats</c>) to maintain JSON serialization backward compatibility.
        /// </summary>
