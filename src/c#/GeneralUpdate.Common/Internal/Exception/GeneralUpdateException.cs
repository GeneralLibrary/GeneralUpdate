...
namespace GeneralUpdate.Common.Internal.Exception
{
    ...
    /// </summary>
    [Serializable]
    public sealed class GeneralUpdateException<TExceptionArgs> : System.Exception, ISerializable
        where TExceptionArgs : BaseArgs
    {
        ...
        public GeneralUpdateException(String message = null, System.Exception innerException = null) : this(null, message, innerException)
        {
        }

        public GeneralUpdateException(TExceptionArgs args, String message = null, System.Exception innerException = null) : base(message, innerException) => m_args = args;
