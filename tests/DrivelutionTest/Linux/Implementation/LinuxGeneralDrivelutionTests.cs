...
/// <summary>
/// Unit tests for <see cref="LinuxGeneralDrivelution"/> following AAAT pattern.
/// Tests constructor validation, pipeline step generation, and interface contract.
/// </summary>
public class LinuxGeneralDrivelutionTests
{
    ...
    public LinuxGeneralDrivelutionTests()
    {
    ...
    public void Ctor_NullValidator_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new LinuxGeneralDrivelution(null!, _backupMock.Object, _commandRunnerMock.Object, _options));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new LinuxGeneralDrivelution(_validatorMock.Object, null!, _commandRunnerMock.Object, _options));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new LinuxGeneralDrivelution(_validatorMock.Object, _backupMock.Object, null!, _options));
    }
