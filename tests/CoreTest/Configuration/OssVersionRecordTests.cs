...
/// <summary>
/// AAAT unit tests for <see cref="OssVersionRecord"/> — property defaults and set/get.
/// Covers: all properties, DateTime precision, null/empty strings.
/// </summary>
public class OssVersionRecordTests
{
    [Fact]
    public void Ctor_Default_AllPropertiesAreDefault()
    {
        var version = new OssVersionRecord();
    ...
    {
        var version = new OssVersionRecord { PacketName = "something" };
    ...
    {
        var version = new OssVersionRecord { Hash = "hash" };
        version.Hash = null;
        Assert.Null(version.Hash);
    }
    ...
    {
        var version = new OssVersionRecord { Version = "1.0" };
    ...
    {
        var version = new OssVersionRecord { Url = "https://a" };
        version.Url = null;
        Assert.Null(version.Url);
    }
    ...
    public void PubTime_UtcNow_StoredCorrectly()
    {
        ...
        var version = new OssVersionRecord { PubTime = now };
    ...
    {
        var version = new OssVersionRecord { PubTime = DateTime.MinValue };
    ...
    {
        var version = new OssVersionRecord { PubTime = DateTime.MaxValue };
