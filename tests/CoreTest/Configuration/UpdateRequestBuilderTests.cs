...
public class UpdateRequestBuilderTests
{
    ...
    [Fact]
    public void SetFiles_Null_InitializesEmptyList()
    {
        var builder = new UpdateRequestBuilder();
        var result = builder.SetFiles(null);
        Assert.Same(builder, result);
    }

    [Fact]
    public void SetFiles_ValidList_Stored()
    {
        var builder = new UpdateRequestBuilder();
    ...
    [Fact]
    public void SetFormats_Null_InitializesEmptyList()
    {
        var builder = new UpdateRequestBuilder();
        var result = builder.SetFormats(null);
        Assert.Same(builder, result);
    }

    [Fact]
    public void SetDirectories_Null_InitializesEmptyList()
    {
        var builder = new UpdateRequestBuilder();
        var result = builder.SetDirectories(null);
        Assert.Same(builder, result);
    }
    ...
    [Fact]
    public void Build_WithRequiredFields_ReturnsUpdateRequest()
    {
    ...
    public void Build_MissingRequiredFields_ThrowsInvalidOperationException()
    {
        ...
        Assert.Contains("Failed to build valid UpdateRequest", ex.Message);
