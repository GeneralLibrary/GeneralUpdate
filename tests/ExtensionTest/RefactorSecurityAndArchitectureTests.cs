...
public class RefactorSecurityAndArchitectureTests : IDisposable
{
    ...
    #region 🔒 SHA256 Hash Verification
    ...
    #region 🐛 FindLatestCompatibleVersion Fix
    ...
    public void FindLatestCompatibleVersion_ShouldNotPickUnparseableVersion()
    {
        ...
        var extensions = new List<ExtensionMetadata>
        {
            ...
            new() { Id = "ext1", Version = "invalid-ver" }, // unparseable — should NOT be selected
    ...
    public void FindLatestCompatibleVersion_AllUnparseableShouldReturnNull()
    {
        ...
        // the ordering doesn't matter — but we should not crash
    ...
    #region 🐛 DownloadResult Error Classification
    ...
    #region 📦 ExtensionMetadata DependencyList
    ...
    #region 📦 Atomic Catalog Write (Orphan Temp File Cleanup)

    [Fact]
    public async Task CatalogSave_ShouldNotLeaveTempFiles()
    {
        // The atomic write uses .tmp → rename. After successful save,
    ...
    #region 🏗️ PlatformMatcher Testability
